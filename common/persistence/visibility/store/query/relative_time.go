...
// Both ASCII "us" and Unicode variants "µs" (U+00B5) and "μs" (U+03BC) are included for microseconds.
...
// ResolveRelativeTimes rewrites NOW()-based expressions to absolute RFC3339Nano timestamps.
